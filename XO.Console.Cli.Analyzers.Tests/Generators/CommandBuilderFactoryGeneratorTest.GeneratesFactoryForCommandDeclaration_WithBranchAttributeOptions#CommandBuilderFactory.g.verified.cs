...
#pragma warning restore CS0436 // Type conflicts with imported type
    ...
    public void AddCommandAttributeCommands(CommandBuilder builder)
    {
        ...
        builder.AddCommand(
            new ConfiguredCommand("group", static (_) => new MissingCommand(), typeof(XO.Console.Cli.CommandParameters))
            {
                Aliases = global::System.Collections.Immutable.ImmutableHashSet.Create("gromp"),
