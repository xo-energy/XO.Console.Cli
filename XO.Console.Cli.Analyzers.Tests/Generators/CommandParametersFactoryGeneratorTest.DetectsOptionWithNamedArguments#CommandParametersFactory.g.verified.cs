        ...
        if (parametersType == typeof(Test.Parameters))
        {
            return new CommandParametersInfo(
                ...
                ImmutableArray.Create<CommandOption>(
                    new CommandOption(
                        "--option",
                        static (context, values, converters) => ((Test.Parameters)context.Parameters).Enable = ConvertSingle<System.Boolean>(values, converters, static (value) => System.Boolean.Parse(value)),
